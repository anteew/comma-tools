...
from .adapters.batch import BatchAdapter, CruiseControlAnalyzerAdapter, RlogToCsvAdapter, CanBitwatchAdapter
from .adapters.realtime import RealtimeAdapter, HybridRxTraceAdapter, CanBusCheckAdapter, PandaStateAdapter
        ...
        try:
            ...
            for artifact_path_str in result.get("artifacts", []):
                ...
                if artifact_path.exists():
                    ...
                    log_callback({"event": "artifact", "name": artifact_meta["name"], "id": artifact_id})
