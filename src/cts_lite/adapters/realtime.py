...
class HybridRxTraceAdapter(RealtimeAdapter):
    ...
    def build_command(self, params: Dict[str, Any]) -> list[str]:
        ...
        return [
            sys.executable, "-m", "comma_tools.monitors.hybrid_rx_trace"
        ]
...
class CanBusCheckAdapter(RealtimeAdapter):
    ...
    def build_command(self, params: Dict[str, Any]) -> list[str]:
        ...
        return [
            sys.executable, "-m", "comma_tools.monitors.can_bus_check"
        ]
...
class PandaStateAdapter(RealtimeAdapter):
    ...
    def build_command(self, params: Dict[str, Any]) -> list[str]:
        ...
        return [
            sys.executable, "-m", "comma_tools.monitors.panda-state"
        ]
