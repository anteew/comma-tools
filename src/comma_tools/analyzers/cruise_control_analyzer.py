...
class CruiseControlAnalyzer:
    ...
    def set_export_config(self, export_csv: bool = False, export_json: bool = False, output_dir: str = ".") -> None:
    ...
    def capture_config_snapshot(self, cli_args: Dict[str, Any], input_metadata: Dict[str, Any]) -> None:
        ...
        if self.export_csv:
            ...
            with open(csv_path, 'w', newline='') as f:
                if segments_data:
                    ...
                    writer = csv.writer(f)
                    writer.writerow(["segment_id", "address", "name", "pre_count", "window_count", "post_count", "delta"])
        ...
        for address, name in self.target_addresses.items():
            ...
            for bit_pos, frequency in stats["bit_frequency"].most_common(10):
                candidates_data.append({
                    ...
                    "frequency": frequency,
                    "score": frequency / stats["message_count"] if stats["message_count"] > 0 else 0,
        ...
        if self.export_csv:
            ...
            with open(csv_path, 'w', newline='') as f:
                if candidates_data:
                    ...
                    writer = csv.writer(f)
                    writer.writerow(["address", "name", "bit_position", "frequency", "score", "label", "total_messages"])
        ...
        if self.export_csv:
            ...
            with open(csv_path, 'w', newline='') as f:
                if edges_data:
                    ...
                    writer = csv.writer(f)
                    writer.writerow(["timestamp", "address", "bit_position", "edge_type", "speed_mph", "main_status", "brake_status"])
        ...
        if self.export_csv:
            ...
            with open(csv_path, 'w', newline='') as f:
                if runs_data:
                    ...
                    writer = csv.writer(f)
                    writer.writerow(["run_id", "start_time", "end_time", "duration", "window_start", "window_end", "window_span", "partial", "start_timestamp", "end_timestamp"])
        ...
        if self.export_csv:
            ...
            with open(csv_path, 'w', newline='') as f:
                if timeline_data:
                    ...
                    writer = csv.writer(f)
                    writer.writerow(["timestamp", "raw_timestamp", "event_type", "description", "speed_mph"])
...
"""
        ...
        if "cruise_buttons" in signal_analysis and signal_analysis["cruise_buttons"].get("set_button_presses"):
            html_content += f"""
...
"""
        ...
        csv_files = ["counts_by_segment.csv", "candidates.csv", "edges.csv", "runs.csv", "timeline.csv"]
