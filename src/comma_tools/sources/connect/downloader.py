...
class LogDownloader:
    ...
    def _build_file_plan(self, route_name: str, dest_root: Path,
                        file_types: Dict[str, bool]) -> List[Tuple[str, Path]]:
        """
        ...
        for file_type, urls in type_mapping.items():
            ...
            for url in urls:
                ...
                if len(url_parts) >= 2:
                    ...
                    dest_path = (dest_root / dongle_id / route_timestamp / 
                               segment / filename)
                    plan.append((url, dest_path))
        
        return plan
    
    def download_route(self, route_name: str, dest_root: Path,
                      file_types: Dict[str, bool], resume: bool = True) -> DownloadReport:
        """
    ...
    def _write_route_index(self, route_name: str, dest_root: Path, 
                          report: DownloadReport) -> None:
