...
class ErrorResponse(BaseModel):
    ...
    technical_details: Dict[str, Any] = Field(default_factory=dict, description="Technical error details")
    suggested_actions: List[str] = Field(default_factory=list, description="Suggested actions to fix the error")
